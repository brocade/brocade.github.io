...
ajax.core.GET.call(null,github.page.repo_uri,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"handler","handler",-195596612),(function (p1__19445_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"process-response","process-response",-26308683),p1__19445_SHARP_], null));
}),new cljs.core.Keyword(null,"error-handler","error-handler",-484945776),(function (p1__19446_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"bad-response","bad-response",1911422950),p1__19446_SHARP_], null));
})], null));

return db;
}));
re_frame.core.register_handler.call(null,new cljs.core.Keyword(null,"process-response","process-response",-26308683),(function (db,p__19447){
var vec__19448 = p__19447;
var _ = cljs.core.nth.call(null,vec__19448,(0),null);
var response = cljs.core.nth.call(null,vec__19448,(1),null);
...
re_frame.core.register_handler.call(null,new cljs.core.Keyword(null,"bad-response","bad-response",1911422950),(function (db,p__19449){
var vec__19450 = p__19449;
var _ = cljs.core.nth.call(null,vec__19450,(0),null);
var response = cljs.core.nth.call(null,vec__19450,(1),null);
...
var title__$1 = cljs.core.get.call(null,map__19458__$1,new cljs.core.Keyword(null,"title","title",636505583));
var href = cljs.core.get.call(null,map__19458__$1,new cljs.core.Keyword(null,"href","href",-793805698));
...
}),items)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul.side-nav","ul.side-nav",1381687621),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"nav-mobile"], null),cljs.core.map.call(null,(function (p__19460){
var map__19461 = p__19460;
var map__19461__$1 = ((((!((map__19461 == null)))?((((map__19461.cljs$lang$protocol_mask$partition0$ & (64))) || (map__19461.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__19461):map__19461);
var title__$1 = cljs.core.get.call(null,map__19461__$1,new cljs.core.Keyword(null,"title","title",636505583));
var href = cljs.core.get.call(null,map__19461__$1,new cljs.core.Keyword(null,"href","href",-793805698));
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"href","href",-793805698),href], null),title__$1], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),title__$1], null));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.row","div.row",133678515),cljs.core.map.call(null,(function (p1__19463_SHARP_){
return github.page.repo_template.call(null,cljs.core.get_in.call(null,p1__19463_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"repo","repo",-1999060679),new cljs.core.Keyword(null,"name","name",1843675177)], null)),cljs.core.get_in.call(null,p1__19463_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"repo","repo",-1999060679),new cljs.core.Keyword(null,"description","description",-1428560544)], null)),cljs.core.get_in.call(null,p1__19463_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"repo","repo",-1999060679),new cljs.core.Keyword(null,"author","author",2111686192)], null)),cljs.core.get_in.call(null,p1__19463_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"repo","repo",-1999060679),new cljs.core.Keyword(null,"html_url","html_url",-1914714112)], null)));
}),repos)], null);
});
...
return cljs.core.map.call(null,(function (p__19467){
var map__19468 = p__19467;
var map__19468__$1 = ((((!((map__19468 == null)))?((((map__19468.cljs$lang$protocol_mask$partition0$ & (64))) || (map__19468.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__19468):map__19468);
var heading = cljs.core.get.call(null,map__19468__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var items = cljs.core.get.call(null,map__19468__$1,new cljs.core.Keyword(null,"items","items",1031954938));
var checked_QMARK_ = cljs.core.get.call(null,map__19468__$1,new cljs.core.Keyword(null,"checked?","checked?",2024809091));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul","ul",-1349521403),cljs.core.map.call(null,(function (p__19473){
...
var title = cljs.core.get.call(null,map__19474__$1,new cljs.core.Keyword(null,"title","title",636505583));
var href = cljs.core.get.call(null,map__19474__$1,new cljs.core.Keyword(null,"href","href",-793805698));
...
var map__19478 = github.state.page_state;
...
var title = cljs.core.get.call(null,map__19478__$1,new cljs.core.Keyword("app","title","app/title",636408784));
var header = cljs.core.get.call(null,map__19478__$1,new cljs.core.Keyword("app","header","app/header",119406797));
var footer = cljs.core.get.call(null,map__19478__$1,new cljs.core.Keyword("app","footer","app/footer",1606476717));
