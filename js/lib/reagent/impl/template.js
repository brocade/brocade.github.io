...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__19061__auto__,writer__19062__auto__,opt__19063__auto__){
return cljs.core._write.call(null,writer__19062__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__20056 = o;
(G__20056[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__20057__delegate = function (args){
...
while (G__20058__i < G__20058__a.length) {G__20058__a[G__20058__i] = arguments[G__20058__i + 0]; ++G__20058__i;}
  args = new cljs.core.IndexedSeq(G__20058__a,0);
} 
return G__20057__delegate.call(this,args);};
...
return G__20057__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__18443__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__18443__auto__){
var and__18443__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__18443__auto____$1){
var and__18443__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
if(cljs.core.truth_(and__18443__auto____$2)){
...
var G__20064 = jsprops;
(G__20064["defaultValue"] = value);

(G__20064["onChange"] = ((function (G__20064,v,value,on_change){
return (function (p1__20062_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__20062_SHARP_);
});})(G__20064,v,value,on_change))
);
...
var vec__20069 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__20069,(0),null);
var id = cljs.core.nth.call(null,vec__20069,(1),null);
var class$ = cljs.core.nth.call(null,vec__20069,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___20072 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___20072 == null)){
} else {
var key_20073 = temp__4661__auto___20072;
(jsprops["key"] = key_20073);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__20075 = (new reagent.impl.template.NativeWrapper());
(G__20075["name"] = c);
...
var len__19525__auto___20081 = arguments.length;
var i__19526__auto___20082 = (0);
while(true){
if((i__19526__auto___20082 < len__19525__auto___20081)){
args__19532__auto__.push((arguments[i__19526__auto___20082]));

var G__20083 = (i__19526__auto___20082 + (1));
i__19526__auto___20082 = G__20083;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__19533__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq20079){
var G__20080 = cljs.core.first.call(null,seq20079);
var seq20079__$1 = cljs.core.next.call(null,seq20079);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__20080,seq20079__$1);
});
...
break;
default:
var G__20087 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__20087;
continue;
...
var n__19370__auto___20088 = a.length;
var i_20089 = (0);
while(true){
if((i_20089 < n__19370__auto___20088)){
(a[i_20089] = reagent.impl.template.as_element.call(null,(a[i_20089])));

var G__20090 = (i_20089 + (1));
i_20089 = G__20090;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__19370__auto___20091 = a.length;
var i_20092 = (0);
while(true){
if((i_20092 < n__19370__auto___20091)){
var val_20093 = (a[i_20092]);
if((cljs.core.vector_QMARK_.call(null,val_20093)) && ((reagent.impl.template.key_from_vec.call(null,val_20093) == null))){
(o["no-key"] = true);
} else {
}

(a[i_20092] = reagent.impl.template.as_element.call(null,val_20093));

var G__20094 = (i_20092 + (1));
i_20092 = G__20094;
continue;
} else {
}
...
var ctx = {};
var vec__20096 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__20096,(0),null);
var derefed = cljs.core.nth.call(null,vec__20096,(1),null);
...
var G__20098 = (cljs.core.count.call(null,argv) - first_child);
switch (G__20098) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__20098){
...
//# sourceMappingURL=template.js.map?rel=1463495152021