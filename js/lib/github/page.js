...
ajax.core.GET.call(null,github.page.repo_uri,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"handler","handler",-195596612),(function (p1__24406_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"process-response","process-response",-26308683),p1__24406_SHARP_], null));
}),new cljs.core.Keyword(null,"error-handler","error-handler",-484945776),(function (p1__24407_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"bad-response","bad-response",1911422950),p1__24407_SHARP_], null));
})], null));

return db;
}));
re_frame.core.register_handler.call(null,new cljs.core.Keyword(null,"process-response","process-response",-26308683),(function (db,p__24408){
var vec__24409 = p__24408;
var _ = cljs.core.nth.call(null,vec__24409,(0),null);
var response = cljs.core.nth.call(null,vec__24409,(1),null);
...
re_frame.core.register_handler.call(null,new cljs.core.Keyword(null,"bad-response","bad-response",1911422950),(function (db,p__24410){
var vec__24411 = p__24410;
var _ = cljs.core.nth.call(null,vec__24411,(0),null);
var response = cljs.core.nth.call(null,vec__24411,(1),null);
...
var title__$1 = cljs.core.get.call(null,map__24419__$1,new cljs.core.Keyword(null,"title","title",636505583));
var href = cljs.core.get.call(null,map__24419__$1,new cljs.core.Keyword(null,"href","href",-793805698));
...
}),items)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul.side-nav","ul.side-nav",1381687621),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"nav-mobile"], null),cljs.core.map.call(null,(function (p__24421){
...
var title__$1 = cljs.core.get.call(null,map__24422__$1,new cljs.core.Keyword(null,"title","title",636505583));
var href = cljs.core.get.call(null,map__24422__$1,new cljs.core.Keyword(null,"href","href",-793805698));
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"href","href",-793805698),href], null),title__$1], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),title__$1], null));
...
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.col.s12.m6","div.col.s12.m6",487623710),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.card.small","div.card.small",-2103458114),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.card-content","div.card-content",1464214949),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.card-title","span.card-title",-453453340),title], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),desc], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.card-action","div.card-action",-289884431),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"href","href",-793805698),link], null),title], null)], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),title], null));
});
github.page.git_cards = (function github$page$git_cards(repos){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.row","div.row",133678515),cljs.core.map.call(null,(function (p1__24424_SHARP_){
return github.page.repo_template.call(null,cljs.core.get_in.call(null,p1__24424_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"repo","repo",-1999060679),new cljs.core.Keyword(null,"name","name",1843675177)], null)),cljs.core.get_in.call(null,p1__24424_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"repo","repo",-1999060679),new cljs.core.Keyword(null,"description","description",-1428560544)], null)),cljs.core.get_in.call(null,p1__24424_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"repo","repo",-1999060679),new cljs.core.Keyword(null,"author","author",2111686192)], null)),cljs.core.get_in.call(null,p1__24424_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"repo","repo",-1999060679),new cljs.core.Keyword(null,"html_url","html_url",-1914714112)], null)));
}),repos)], null);
});
...
return cljs.core.map.call(null,(function (p__24428){
...
var heading = cljs.core.get.call(null,map__24429__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var items = cljs.core.get.call(null,map__24429__$1,new cljs.core.Keyword(null,"items","items",1031954938));
var checked_QMARK_ = cljs.core.get.call(null,map__24429__$1,new cljs.core.Keyword(null,"checked?","checked?",2024809091));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul","ul",-1349521403),cljs.core.map.call(null,(function (p__24434){
...
var title = cljs.core.get.call(null,map__24435__$1,new cljs.core.Keyword(null,"title","title",636505583));
var href = cljs.core.get.call(null,map__24435__$1,new cljs.core.Keyword(null,"href","href",-793805698));
...
var map__24439 = github.state.page_state;
...
var title = cljs.core.get.call(null,map__24439__$1,new cljs.core.Keyword("app","title","app/title",636408784));
var header = cljs.core.get.call(null,map__24439__$1,new cljs.core.Keyword("app","header","app/header",119406797));
var footer = cljs.core.get.call(null,map__24439__$1,new cljs.core.Keyword("app","footer","app/footer",1606476717));
...
//# sourceMappingURL=page.js.map?rel=1455751535570