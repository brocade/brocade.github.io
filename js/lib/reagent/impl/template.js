...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__17496__auto__,writer__17497__auto__,opt__17498__auto__){
return cljs.core._write.call(null,writer__17497__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__18485 = o;
(G__18485[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__18487__i < G__18487__a.length) {G__18487__a[G__18487__i] = arguments[G__18487__i + 0]; ++G__18487__i;}
  args = new cljs.core.IndexedSeq(G__18487__a,0);
} 
...
if(cljs.core.truth_((function (){var and__16886__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__16886__auto__){
var and__16886__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__16886__auto____$1){
var and__16886__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
if(cljs.core.truth_(and__16886__auto____$2)){
...
var G__18493 = jsprops;
(G__18493["defaultValue"] = value);

(G__18493["onChange"] = ((function (G__18493,v,value,on_change){
return (function (p1__18491_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__18491_SHARP_);
});})(G__18493,v,value,on_change))
);
...
var vec__18498 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__18498,(0),null);
var id = cljs.core.nth.call(null,vec__18498,(1),null);
var class$ = cljs.core.nth.call(null,vec__18498,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___18501 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___18501 == null)){
} else {
var key_18502 = temp__4661__auto___18501;
(jsprops["key"] = key_18502);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__18504 = (new reagent.impl.template.NativeWrapper());
(G__18504["name"] = c);
...
var len__17956__auto___18510 = arguments.length;
var i__17957__auto___18511 = (0);
while(true){
if((i__17957__auto___18511 < len__17956__auto___18510)){
args__17963__auto__.push((arguments[i__17957__auto___18511]));

var G__18512 = (i__17957__auto___18511 + (1));
i__17957__auto___18511 = G__18512;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__17964__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq18508){
var G__18509 = cljs.core.first.call(null,seq18508);
var seq18508__$1 = cljs.core.next.call(null,seq18508);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__18509,seq18508__$1);
});
...
break;
default:
var G__18516 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__18516;
continue;
...
var n__17801__auto___18517 = a.length;
var i_18518 = (0);
while(true){
if((i_18518 < n__17801__auto___18517)){
(a[i_18518] = reagent.impl.template.as_element.call(null,(a[i_18518])));
...
var a = cljs.core.into_array.call(null,s);
var n__17801__auto___18520 = a.length;
var i_18521 = (0);
while(true){
if((i_18521 < n__17801__auto___18520)){
var val_18522 = (a[i_18521]);
if((cljs.core.vector_QMARK_.call(null,val_18522)) && ((reagent.impl.template.key_from_vec.call(null,val_18522) == null))){
(o["no-key"] = true);
} else {
}

(a[i_18521] = reagent.impl.template.as_element.call(null,val_18522));

var G__18523 = (i_18521 + (1));
i_18521 = G__18523;
continue;
} else {
}
...
var ctx = {};
var vec__18525 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__18525,(0),null);
var derefed = cljs.core.nth.call(null,vec__18525,(1),null);
...
var G__18527 = (cljs.core.count.call(null,argv) - first_child);
switch (G__18527) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__18527){
